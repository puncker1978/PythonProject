...
# Задание 4: Напишите программу, которая считывает у пользователя два числа x и y.
# После этого она должна вычислить значение функции по этим числам.
x, y = int(input('Первый аргумент: ')), int(input('Второй аргумент: '))
print('Значение функции: ', (4 + x) / (x + 3) / (y - 5))